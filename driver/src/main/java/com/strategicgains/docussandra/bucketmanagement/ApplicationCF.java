...
import static com.strategicgains.docussandra.bucketmanagement.NewCassandraPersistanceUtils.getIndexMetadata;
...
public enum ApplicationCF implements CFEnum {
    ...
    APPLICATION_ROLES( "Application_Roles", "BytesType" ),;//<-- ;added by udeyoje

    /** Application counters */
    //commented out by udeyoje: APPLICATION_AGGREGATE_COUNTERS( "Application_Aggregate_Counters", "LongType", COUNTERTYPE.getClassName() ),

    /** Entity counters */
    //commented out by udeyoje: ENTITY_COUNTERS( "Entity_Counters", "BytesType", COUNTERTYPE.getClassName() ),;
