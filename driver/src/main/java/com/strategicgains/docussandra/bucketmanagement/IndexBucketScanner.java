...
public class IndexBucketScanner implements IndexScanner {
    ...
    private TreeSet<Column<ByteBuffer, ByteBuffer>> lastResults;
    ...
    public boolean load() throws Exception {
        ...
        TreeSet<Column<ByteBuffer, ByteBuffer>> resultsTree = IndexMultiBucketSetLoader
    ...
    public NavigableSet<Column<ByteBuffer, ByteBuffer>> next() {
        NavigableSet<Column<ByteBuffer, ByteBuffer>> returnVal = lastResults;
