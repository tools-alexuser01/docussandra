...
import static com.strategicgains.docussandra.bucketmanagement.ConversionUtils.uuid;
...
public class UUIDUtils
{
    ...
    /**
     * Return the "next" UUID in micro second resolution. <b>WARNING</b>: this
     * is designed to return the next unique timestamped UUID for this JVM.
     * Depending on velocity of the call, this method may block internally to
     * insure that "now" is kept in sync with the UUIDs being generated by this
     * call.
     * <p/>
     * In other words, we will intentionally burn CPU insuring that this method
     * is not executed more than 10k -1 times per millisecond and guarantee that
     * those microseconds held within are sequential.
     * <p/>
     ...
     * period in time. I.E
     * <p/>
     * newTimeUUID(1000, 0) <br/> newTimeUUID(1000, 1) <br /> newTimeUUID(1000,
     * 2) <br />
     * <p/>
     * etc.
     * <p/>
     * Only use this method if you are absolutely sure you need it. When it
     * doubt use the method without the timestamp offset
     *
     * @param ts The timestamp in milliseconds
     * @param timeoffset The offset, which should always be <= 10000. If you go
     * beyond this range, the millisecond will be incremented since this is
     * beyond the possible values when coverrting from millis to 1/10
     * microseconds stored in the time uuid.
     */
     ...
     * chronologically. If a large number of subsequent calls are made to this
     * method (>1000) with the same timestamp, you will have non-unique temporal
     * values stored in your UUID.
     */
